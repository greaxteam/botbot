...
exports.run = async (client, message, args) => {    let cooldown = 8.64e+7, // 24 Saat
    ...
    .setDescription('Bu Komutu Sadece `24 Saatte` Bir Kullanabilirsin.')
        ...
        const embed = new Discord.RichEmbed()
  .setTitle('Başarılı')
.setDescription('**Sunucunuz Başarıyla** [Destek Sunucumda](https://discord.gg/bfCqmJw) **Tanıtıldı. <a:100:528885493207793665>**\n**24 Saat Sonra Tekrar Sunucunuzu Tanıtabilirsiniz.**')
        .setColor('GREEN')
 message.channel.sendEmbed(embed);
    message.channel.createInvite({maxAge: 0}).then((invite) => {
      ...
      .setThumbnail(message.guild.iconURL)
       client.channels.get('632524098945286194').send(embed)
