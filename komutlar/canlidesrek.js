...
const emoji = message.client.emojis.get('📞');
      ...
      let destekKanal = "632546191044771851";
      ...
      if (reason === 'success') {
        ...
        client.on('message', message => {
          function contact() {
            ...
            if (message.channel.id === chan.id) client.channels.get(destekKanal).send(`**Talep Eden Kişi:** ${message.author.tag} : ${message.content}`)
